    ...
    <div class="detail-card">
      ...
      <div class="detail-info">
        ...
        <p class="description" v-if="restaurant.price">
          Nikmati sajian spesial dari <strong>{{ restaurant.name }}</strong> yang dibuat dengan bahan-bahan pilihan dan rasa autentik yang menggugah selera. Cocok untuk makan siang, makan malam, atau sekadar mengganjal perut di kala lapar!
        </p>
    ...
    <div v-if="restaurant.price" class="reviews">
      ...
      <div class="add-review">
        ...
        <form @submit.prevent="submitReview">
          <input type="text" v-model="newReview.name" placeholder="Nama Anda" required />
          <textarea v-model="newReview.comment" placeholder="Komentar Anda" required></textarea>
...
export default {
  ...
  methods: {
    submitReview() {
      if (!this.newReview.name || !this.newReview.comment || !this.newReview.rating) return;
      this.reviews.push({ ...this.newReview });
      this.newReview = { name: '', comment: '', rating: '' };
    }
  }
};
</script>
